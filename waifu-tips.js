...
//看板娘样式设置
live2d_settings['waifuSize']            = '180x150';    // 看板娘大小，例如 '180x150', '600x535'
live2d_settings['waifuTipsSize']        = '150x30';     // 提示框大小，例如 '150x30', '570x150'
...
live2d_settings['aboutPageUrl']         = 'https://gkdworld.xyz';   // 关于页地址, '{URL 网址}'
